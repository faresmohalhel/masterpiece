      ...
      <div className="flex lg:flex-row-reverse flex-col-reverse items-center min-h-screen pt-6 sm:justify-center sm:pt-0">
        ...
        <div className="w-full lg:w-1/2 px-6 py-4 mt-6 overflow-hidden bg-white sm:max-w-lg sm:rounded-lg">
          <form onSubmit={handleSubmit}>
            ...
            <a href="#" className="text-xs text-primary-color hover:underline">
              Forget Password?
            </a>
          ...
          <div className="mt-4 text-primary-text text-center">
            Don't have an account?{" "}
            <span>
              <a className="text-primary-color hover:underline" href="#">
                Sign up
              </a>
            </span>
          </div>
          ...
          <div className="my-6 space-y-2 text-primary-text">
            <button
