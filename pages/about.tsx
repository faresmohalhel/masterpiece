        ...
        <div className="flex flex-wrap items-center ">
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
            <div className="lg:max-w-md">
              <span className="text-xl font-semibold text-orange-400 uppercase dark:text-orange-400">
                About Us
              </span>
          ...
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
            <div className="flex mb-4">
              <span className="flex items-center justify-center flex-shrink-0 w-12 h-12 mr-6 bg-orange-400 rounded dark:bg-orange-400 dark:text-gray-100 text-gray-50">
                <svg
